...
# use the scale() function to z-score standardize a data frame..........why
# normalize 0-1 gets rid of outliers while z score spans from -inf to +inf so doesn't remove outliers
...
# for k =5, 21 errors = 2 so these are the  best outcomes
